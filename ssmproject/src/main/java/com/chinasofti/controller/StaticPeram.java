...
public  class  StaticPeram {
	...
	// 替换成你的AK (产品密)
	public final static String accessKeyId = "LTAIyKBL3fQ1WbN1";// 你的accessKeyId,填你自己的 上文配置所得  自行配置
	public final static String accessKeySecret = "lnRoNGeKoWezacQdbVYFAZ8LCP3GYu";// 你的accessKeySecret,填你自己的 上文配置所得 自行配置
	// 必填:短信签名-可在短信控制台中找到
	public final static String SignName = "中软CQETC";   // 阿里云配置你自己的短信签名填入
	// 必填:短信模板-可在短信控制台中找到
	public final static String TemplateCode = "SMS_172741542"; // 阿里云配置你自己的短信模板填入
