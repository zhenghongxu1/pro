            ...
            <div id="content_box">
                ...
                <div class="imfor">
                    ...
                    <div class="pices">
                        ...
                        <p class="pices_information"><b>￥</b><span>${ci.item.price} <input type="hidden" name="" value=""></span></p>
                    </div>
                    <div class="num"><span class="reduc">&nbsp;-&nbsp;</span><input type="text" value="${ci.num }" ><span class="add">&nbsp;+&nbsp;</span></div>
                    <div class="totle">
                        <span>￥</span>
                        <span class="totle_information">
                        ${ci.item.price*ci.num}
                        </span>
                    </div>
                    <div class="del">
                        <!-- <div>
                        ...
                        -->
                        <a href="deleteCard.do?goodsid=${ci.item_id }" class="del_d">删除</a>
                    </div>
                </div>
