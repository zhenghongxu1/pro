...
<!-- <header id="top">
    ...
    <div class="rt">
        <ul class="lf">
            ...
            <li><a href="cart.do" title="我的购物车"><img class="shopcar" src="../images/header/shop_car.png" alt=""/></a><b>|</b></li>
...
<div class="ck-slide">
    <ul class="ck-slide-wrapper">
        <li>
            <a href="detils.do?id=536563" ><img src="../images/index/index_banner1.png" alt=""></a>
        </li>
        <li style="display:none">
            <a  href="detils.do?id=679532"><img src="../images/index/index_banner2.png" alt=""></a>
        </li>
        <li style="display:none">
