    ...
    <div class="rightsidebar_box rt">
        ...
        <div class="rs_content">
            ...
            <div class="old_password" >
                <span class="word">旧密码：</span><input id="passwordOld" name="passwordOld" type="password" />
            </div>
             <div class="new_password">
                <span class="word">新密码：</span><input id="passwordNew" name="passwordNew" type="password"/><span class="change_hint"></span>
            </div>
            <div class="confirm_password">
                <span class="word">确认新密码：</span><input id="passwordConfirm" name="passwordConfirm" type="password"/><span class="confirm_hint"></span>
            </div>
            
            <div class="save_password" >
                                   <a id="aa" onclick="dianji()" style="color: white;">保存修改</a>
            </div>
        </div>
    </div>
</div>
...
function dianji(){
				aa.href="change.do?passwordOld="+passwordOld.value+"&passwordNew="+passwordNew.value+"&passwordConfirm="+passwordConfirm.value;
			}
</script>
